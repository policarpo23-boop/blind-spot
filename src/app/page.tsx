        ...
        <main id="main-content" className="min-h-screen">
          ...
          >
            <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
              <span className="text-xl font-bold tracking-tight group cursor-default">
                Blind<span className="text-[var(--accent)] group-hover:animate-pulse">Spot</span>
              </span>
              <a
                href="#subscribe"
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <NewsletterCard
                  ...
                  hotTake="The VIX is lying to you. Volatility isn't fear — it's opportunity mispriced by people who read the same three newsletters."
                />
                <NewsletterCard
                  emoji="🤖"
                  title="Tech"
                  ...
                  frequency="Weekly"
                  hotTake="90% of 'AI startups' are a GPT wrapper with a landing page. The real disruption is in the infrastructure nobody's watching."
                />
                <NewsletterCard
                  emoji="🔥"
                  title="Culture"
                  ...
                  frequency="Biweekly"
                  hotTake="Remote work isn't dying — offices are. Companies mandating RTO are just subsidizing commercial real estate with employee commute time."
                />
              </div>
            </div>
          </section>
          ...
          <footer className="py-12 px-6 border-t border-white/5">
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <span className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors cursor-default" title="You actually read the footer? Respect.">
